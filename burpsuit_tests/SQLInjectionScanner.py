# Burp Suite Extension: SQL Injection Scanner
# This script uses Burp Suite's API to scan for SQL injection vulnerabilities
# and generates or updates a Markdown report file for the target website.
...
class BurpExtender(IBurpExtender, IScannerCheck):
    ...
    def doActiveScan(self, baseRequestResponse, insertionPoint):
        ...
        for payload in payloads:
            ...
            if self.isVulnerable(response):
                ...
                vuln_type = "Injection Flaw"
                detail = "The application appears vulnerable to SQL injection attacks. Payload used: {}".format(payload)
                risk = "High"
    ...
    def isVulnerable(self, response):
        # Simple check for common SQL error messages in the response
        return re.search(b"(SQL syntax|mysql_fetch_array|ORA-01756|UNION SELECT)", response.getResponse())
