# Burp Suite Extension: XSS Scanner
# This script uses Burp Suite's API to scan for reflected XSS vulnerabilities
...
class BurpExtender(IBurpExtender, IScannerCheck):
    ...
    def doActiveScan(self, baseRequestResponse, insertionPoint):
        ...
        responseStr = self._helpers.bytesToString(response.getResponse())
        if payload in responseStr:
            vuln_name = "Reflected XSS"
            vuln_type = "Cross-Site Scripting"
            detail = "The application appears vulnerable to Cross-Site Scripting (XSS). Payload used: {}".format(payload)
            risk = "Medium"
